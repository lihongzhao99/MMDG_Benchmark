...
from dataloaders.dataloader_HAC_corruption import HACDOMAIN

# python test_HAC_corruption.py  -s 'human' 'animal' -t 'cartoon' --use_video --use_audio --resumef models/log_ERM_human_animal2cartoon_video_audio_seed_0_best.pt --datapath /path/to/HAC_DATA_ROOT --use_audio_corruption
# python test_HAC_corruption.py  -s 'human' 'animal' -t 'cartoon' --use_video --use_audio --resumef models/log_ERM_human_animal2cartoon_video_audio_seed_0_best.pt --datapath /path/to/HAC_DATA_ROOT --use_video_corruption
...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_video_corruption", action="store_true")
    parser.add_argument("--use_audio_corruption", action="store_true")
    ...
    test_dataset = HACDOMAIN(
        ...
        use_video_corruption=args.use_video_corruption,
        use_audio_corruption=args.use_audio_corruption,
    )
